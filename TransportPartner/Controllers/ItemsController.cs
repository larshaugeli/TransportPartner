...
namespace TransportPartner.Controllers
{
    public class ItemsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,ProductId,Developer,Genre,Price")] Item item)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,ProductId,Developer,Genre,Price")] Item item)
        {
            if (id != item.Id)
            {
                return NotFound();
